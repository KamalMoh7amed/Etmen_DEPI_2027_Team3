        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetPasswordToken = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrisisName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CrisisConfiguration_Type", "CrisisType IN (1,2,3,4)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    EmergencyType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_EmergencyRequest_Status", "Status IN (1,2,3,4,5,6)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthcareProviders_IsEmergencyCenter",
                table: "HealthcareProviders",
                column: "IsEmergencyCenter");

            migrationBuilder.CreateIndex(
                name: "IX_HealthcareProviders_Latitude_Longitude",
                table: "HealthcareProviders",
